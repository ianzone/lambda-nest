...
export function makeError(statusCode: number | string, message?: string): HttpException {
  const status = typeof statusCode === 'string' ? Number.parseInt(statusCode) : statusCode;
